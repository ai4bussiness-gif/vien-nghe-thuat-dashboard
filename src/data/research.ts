...
export const researchProjects: ResearchProject[] = [
  {
    ...
    leadCenter: "Trung tâm thiết kế nội ngoại thất",
    collaboratingCenters: ["Trung tâm in và ấn loát nghệ thuật"],
    period: "03/2026 – 12/2026",
    progress: 65,
    status: "Đang thực hiện",
    shortDesc:
      "Đánh giá và ứng dụng các vật liệu tái chế (nhựa, gỗ công nghiệp, vải thừa) vào sản phẩm nội thất — hướng tới thiết kế bền vững.",
  ...
  },
  {
    id: "dk-01",
    title:
      "Ứng dụng AI trong điêu khắc tạo hình — thực nghiệm với generative modeling",
    leadCenter: "Trung tâm điêu khắc",
    collaboratingCenters: ["Trung tâm quản lý và đào tạo"],
    period: "01/2026 – 08/2026",
    progress: 20,
    status: "Đang thực hiện",
    shortDesc:
      "Khám phá khả năng kết hợp thuật toán sinh 3D với kỹ thuật điêu khắc truyền thống để tạo ra các tác phẩm lai ghép.",
  ...
  },
  {
    ...
    leadCenter: "Trung tâm in và ấn loát nghệ thuật",
    ...
    status: "Đang thực hiện",
    shortDesc:
      "Số hóa quy trình in khắc gỗ truyền thống, kết hợp thiết kế nội thất ứng dụng cho không gian đương đại.",
  ...
  },
  {
    ...
    leadCenter: "Trung tâm quản lý và đào tạo",
    collaboratingCenters: [
      "Trung tâm thiết kế nội ngoại thất",
      "Trung tâm điêu khắc",
      "Trung tâm in và ấn loát nghệ thuật",
    ...
    status: "Hoàn thành",
    shortDesc:
      "Đề xuất khung chương trình đào tạo mới tích hợp kỹ năng số, tư duy phản biện và thực hành liên ngành.",
  ...
  },
  {
    id: "nt-02",
    title:
      "Thiết kế không gian học tập linh hoạt cho đào tạo nghệ thuật thế hệ mới",
    leadCenter: "Trung tâm thiết kế nội ngoại thất",
    collaboratingCenters: ["Trung tâm quản lý và đào tạo"],
    ...
    status: "Hoàn thành",
    shortDesc:
      "Đề xuất mô hình không gian xưởng thực hành đa năng có thể tái cấu hình linh hoạt.",
  ...
  },
  {
    id: "dk-02",
    title:
      "Điêu khắc công cộng trong đô thị Hà Nội — từ ý tưởng đến triển khai",
    leadCenter: "Trung tâm điêu khắc",
    collaboratingCenters: [
      "Trung tâm quản lý và đào tạo",
      "Trung tâm in và ấn loát nghệ thuật",
    ...
    status: "Hoàn thành",
    shortDesc:
      "Khảo sát và đề xuất quy trình tích hợp tác phẩm điêu khắc vào không gian công cộng tại Hà Nội.",
  ...
  },
  {
    id: "in-02",
    title:
      "Phát triển chất liệu in trên nền vải tự nhiên kết hợp kỹ thuật nhuộm thực vật",
    leadCenter: "Trung tâm in và ấn loát nghệ thuật",
    collaboratingCenters: [],
    ...
    status: "Đang thực hiện",
    shortDesc:
      "Nghiên cứu quy trình in ấn trên vải lanh, tơ tằm bằng mực nhuộm từ thực vật — hướng tới thời trang bền vững.",
  ...
  },
  {
    ...
    status: "Đề xuất",
    shortDesc:
      "Xây dựng đề án chương trình artist-in-residence cho nghệ sĩ trong nước và quốc tế.",
...
export const centerColors: Record<
  string,
